...
def process_schedules(schedules):
    ...
    print("Guard who spent the most time asleep: {}".format(max_guard))
    print("Which minute did they spend asleep the most: {}".format(
        schedules[max_guard].index(max(schedules[max_guard]))
    ))
